...
const CHAT_STEPS = [
  ...
  {
    key: 'service',
    prompt: 'Bienvenido al sistema MotoWeb. Selecciona el servicio requerido:',
...
function TerminalChat() {
  ...
  const [messages, setMessages] = useState([
    { type: 'system', text: 'MotoWeb TELEMETRÍA v2.4.1 — Sistema activo' },
  ...
  return (
    <div className="terminal-wrap">
      <div className="terminal-header">
        ...
        <div className="terminal-title">MotoWeb_TELEMETRÍA — CANAL SEGURO</div>
      </div>
